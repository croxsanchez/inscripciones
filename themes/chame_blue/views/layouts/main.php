...
<div class="navbar navbar-static-top">
  <div class="navbar-inner">
    <div class="container">
      ...
      <a class="brand" href="#">CEVAM - Inscripciones</a>
      ...
      <div class="span12">
        <?php foreach($msgs as $type => $message):?>
          <div class="alert alert-<?php echo $type?>">
            ...
            <h4><?php if ($type=="warning") echo ucfirst("Advertencia");
                      else if ($type=="success") echo ucfirst("Éxito");
                      else echo ucfirst($type);?>!</h4>
            <?php echo $message?>
          </div>
        <?php endforeach;?>
      </div>
...
<footer class="footer bg-ft clearfix pd4">
            ...
            <div class="span3">
                <section>
                    ...
                    <p>CEVAM Mérida<br>
                        123456 <br>
                        Mérida Venezuela<br>
                        <strong>phone:</strong> <a href="tel:+58-274-263XXXX" class="tele">+58-274-263XXXX</a><br>
                        <strong>fax:</strong> +58-274-263XXXX<br>
                        <span class="overflow"><strong>email:</strong> <a href="mailto:email@domain.com">crox.sanchez@gstca.com</a></span> </p>
                </section>
                <!--close section-->
 ...
 <section class="footer-credits">
    <div class="container">
        <ul class="clearfix">
            <li>© 2015 - Gryphus Soluciones Tecnológicas C.A. All rights reserved.</li>
            <li><a href="#">Link</a></li>
            <li><a href="#">Link</a></li>
        </ul>
    </div>
